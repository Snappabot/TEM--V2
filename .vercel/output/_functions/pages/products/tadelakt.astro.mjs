...
const $$Tadelakt = createComponent(($$result, $$props, $$slots) => {
  const product = {
    name: "Tadelakt",
    tagline: "Polished Plaster",
    description: "High-performance decorative coating delivering polished, waterproof finishes ideal for wet areas. Traditional Moroccan technique with modern performance \u2014 can be polished to a glossy finish using a polishing stone.",
    image: "/images/products/tadelakt/Tadelakt+moody+shower.jpg",
    features: [
      "Polishable to a beautiful glossy finish",
    ...
    benefits: [
      "Perfect for bathrooms \u2014 the traditional choice for wet areas",
      "Floor application available for seamless spaces",
      "Traditional Moroccan luxury with modern durability",
      "Polished stone can create a stunning glossy finish",
      "UV stable \u2014 maintains colour in direct sunlight",
      "Suitable for hotels, restaurants, and high-end residential",
      "Made in Western Australia"
    ],
    gallery: [
      { src: "/images/products/tadelakt/Tadelakt+moody+shower.jpg", title: "Moody Shower" },
      { src: "/images/products/tadelakt/Tadelakt+bathroom+1.png", title: "Bathroom" },
      { src: "/images/products/tadelakt/Tadelakt+green.png", title: "Green Tadelakt" },
      { src: "/images/products/tadelakt/Tadelakt+pink+blush.png", title: "Pink Blush" },
      { src: "/images/products/tadelakt/TADELAKT1.png", title: "Classic Finish" }
    ]
  };
...
}, "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/tadelakt.astro", void 0);

const $$file = "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/tadelakt.astro";
const $$url = "/products/tadelakt";
