...
const $$Tadelino = createComponent(($$result, $$props, $$slots) => {
  const product = {
    name: "Tadelino",
    tagline: "Versatile Polished Plaster",
    description: "High-performance decorative coating similar to Tadelakt, delivering modern, classic, or rustic finishes. Slightly easier application than traditional Tadelakt while maintaining the polished aesthetic \u2014 perfect for those who want versatility without compromising on beauty.",
    image: "/images/products/tadelakt/Tadelakt+moody+shower.jpg",
    features: [
      "Polishable to a glossy finish",
      "Modern, classic, or rustic aesthetics",
    ...
    benefits: [
      "More versatile than traditional Tadelakt",
      "Floor application available for seamless spaces",
      "Easier application without sacrificing quality",
      "Polishing stone creates stunning glossy finish",
      "Perfect for hallways, stairways, living areas",
      "Suitable for hotels, restaurants, high-end residential",
      "Made in Western Australia"
    ],
    gallery: [
      { src: "/images/products/tadelakt/Tadelakt+moody+shower.jpg", title: "Polished Finish" },
      { src: "/images/products/tadelakt/Tadelakt+bathroom+1.png", title: "Bathroom" },
      { src: "/images/products/tadelakt/Tadelakt+green.png", title: "Green Tadelino" },
...
}, "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/tadelino.astro", void 0);

const $$file = "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/tadelino.astro";
const $$url = "/products/tadelino";
