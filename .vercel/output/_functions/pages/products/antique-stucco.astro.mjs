...
const $$AntiqueStucco = createComponent(($$result, $$props, $$slots) => {
  const product = {
    name: "Antique Stucco",
    tagline: "Aged Elegance",
    description: "Premium, trowel-applied decorative wall coating designed to provide a smooth, aged appearance reminiscent of Southern European architecture. Known to age beautifully over time, developing character and charm.",
    image: "/images/products/antique-stucco.png",
    features: [
      "Smooth, aged Southern European aesthetic",
      "Interior and exterior walls, ceilings, and landscaping",
      "3-coat system: Primer \u2192 Antique Stucco \u2192 Sealer",
      "Ages beautifully \u2014 develops character over time",
      "Sealer available to slow aging while preserving beauty",
      "Low VOC \u2014 Green Star compliant",
      "Non-combustible (AS 1530.1 certified)",
      "10-Year Limited Warranty"
    ],
    benefits: [
      "Authentic aged European character",
      "Perfect for entries, hotels, restaurants, showrooms",
      "Suitable for high-traffic areas",
      "Natural aging adds value and charm",
      "Custom colours available",
      "Great coverage per square metre",
      "Made in Western Australia"
    ],
    gallery: [
      { src: "/images/products/antique-stucco/Antique+stucco+fireplace.png", title: "Fireplace" },
      { src: "/images/products/antique-stucco/Antique+stucco+entry.png", title: "Entry" },
      { src: "/images/products/antique-stucco/Antique+stucco+french+window.png", title: "French Window" },
      { src: "/images/products/antique-stucco/Antique+stucco+hallway.png", title: "Hallway" },
      { src: "/images/products/antique-stucco/Antique+stucco+patio.png", title: "Patio" },
      { src: "/images/products/antique-stucco/Antique+stucco+with+gold+patina.png", title: "Gold Patina" }
    ]
  };
...
}, "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/antique-stucco.astro", void 0);

const $$file = "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/antique-stucco.astro";
const $$url = "/products/antique-stucco";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$AntiqueStucco,
  file: $$file,
  url: $$url
