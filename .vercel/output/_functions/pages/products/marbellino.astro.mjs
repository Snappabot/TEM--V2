...
const $$Marbellino = createComponent(($$result, $$props, $$slots) => {
  const product = {
    name: "Marbellino",
    tagline: "Stone-Like Venetian Plaster",
    description: "High-performance decorative coating creating surfaces with elevated aesthetic value and a stone-like, slightly marbled effect. Suitable for modern and classic architectural designs \u2014 the only Troweled Earth product approved for floor applications.",
    image: "/images/products/marbellino/Marbellino+curved+sunset.jpg",
    features: [
      "Stone-like, marbled aesthetic with subtle undulations",
      "Suitable for walls, ceilings, and internal floors",
      "4-5 coat system for superior durability and depth",
      "Interior and exterior use \u2014 including bathrooms",
    ...
    benefits: [
      "Stone look without the weight or cost of natural stone",
      "Repairable and patchable with no visible marks",
      "Each wall is unique \u2014 obvious contrast and colour movement",
      "Unique floor application capability \u2014 rare among decorative plasters",
      "Highly water resistant and UV stable",
      "Flexible \u2014 resists web cracking unlike traditional plasters",
      "Made in Australia"
    ],
    gallery: [
      { src: "/images/products/marbellino/Marbellino+state+of+kin.jpg", title: "State of Kin" },
      { src: "/images/products/marbellino/Marbellino+spiral+stair.jpg", title: "Spiral Stair" },
      { src: "/images/products/marbellino/Marbellino+white+curves.jpg", title: "White Curves" },
      { src: "/images/products/marbellino/Marbellino+outdoor+arches.jpg", title: "Outdoor Arches" },
      { src: "/images/products/marbellino/Marbellino+hallway+art.jpg", title: "Hallway" },
      { src: "/images/products/marbellino/Marbellino+stairwell+art.jpg", title: "Stairwell" },
      { src: "/images/products/marbellino/Marbellino+angular+exterior.jpg", title: "Angular Exterior" },
      { src: "/images/products/marbellino/Marbellino+kitchen.png", title: "Kitchen" },
      { src: "/images/products/marbellino/Marbellino+ivory+shower.jpg", title: "Ivory \u2014 Shower" },
      { src: "/images/products/marbellino/Marbellino+ivory+arch+niche.jpg", title: "Ivory \u2014 Arch Niche" },
      { src: "/images/products/marbellino/Marbellino+common+grey+half.jpg", title: "Common Grey Half" },
      { src: "/images/products/marbellino/Marbellino+common+grey+stairwell+1.jpg", title: "Common Grey \u2014 Stairwell" },
      { src: "/images/products/marbellino/Marbellino+common+grey+stairwell+2.jpg", title: "Common Grey \u2014 Stairwell II" },
      { src: "/images/products/marbellino/Marbellino+common+grey+stairwell+3.jpg", title: "Common Grey \u2014 Feature Wall" },
      { src: "/images/products/marbellino/Marbellino+common+grey+hallway.jpg", title: "Common Grey \u2014 Hallway" },
      { src: "/images/products/marbellino/Marbellino+exterior+jarrad.jpg", title: "Concrete Dark \u2014 Exterior" },
      { src: "/images/products/marbellino/bathroom+marbellino+1.png", title: "Bathroom" },
      { src: "/images/products/marbellino/Marbellino+shop+in+smokey+grey.png", title: "Commercial" }
    ]
  };
...
}, "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/marbellino.astro", void 0);

const $$file = "/home/sittrapp/clawd/projects/troweled-earth/TEM-V2/src/pages/products/marbellino.astro";
const $$url = "/products/marbellino";
